              ...
              <div className='bg-white/95 backdrop-blur-md border border-gray-100/50 rounded-3xl shadow-2xl'>
                ...
                <div className='divide-y divide-gray-100/50'>
                  {cartItems.map((item, index) => {
                    ...
                    console.log('Cart item:', { item, itemId, currentItem, index }) // Debug log
                    
                    return (
                      <div 
                        key={`${item.itemType}-${itemId}-${index}`} 
                      ...
                      >
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 md:gap-6'>
                          <div className='w-16 h-16 sm:w-20 md:w-24 lg:h-28 lg:w-32 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl flex-shrink-0 overflow-hidden border border-gray-200 group-hover:border-shop_dark_green/30 transition-all duration-300 relative'>
                            {currentItem?.image ? (
                              currentItem.image.startsWith('/api/placeholder/') ? (
                                <img 
                                ...
                                <img 
                                  ...
                                  onError={(e) => {
                                    ...
                                    if (parent) {
                                      parent.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center"><div class="w-8 h-8 sm:w-10 md:w-12 md:h-12 lg:h-16 bg-gray-300 rounded-lg"></div></div>';
                                    }
                                  }}
                                />
                              ) : (
                        ...
                        product.image.startsWith('/api/placeholder/') ? (
                          ...
                          <img 
                            ...
                            onError={(e) => {
                              ...
                              const parent = target.parentElement;
                              if (parent) {
                                parent.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center"><div class="w-8 h-8 bg-gray-300 rounded"></div></div>';
                              }
                            }}
                          />
                        ) : (
