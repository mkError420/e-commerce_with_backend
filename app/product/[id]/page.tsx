...
const ProductDetailPage = () => {
  ...
  if (loading) return <div className='min-h-screen flex items-center justify-center'><div className='animate-spin w-10 h-10 border-2 border-green-500 border-t-transparent rounded-full' /></div>
  if (!product) {
    return (
                  ...
                  allImages[selectedImage].startsWith('/api/placeholder/') ? (
                    ...
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          parent.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center"><div class="text-gray-400 text-center"><div class="w-32 h-32 bg-gray-300 rounded-lg mx-auto mb-4"></div><p class="text-sm">Image not available</p></div></div>';
                        }
                      }}
                    />
                  ) : (
                      ...
                      image.startsWith('/api/placeholder/') ? (
                        ...
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            const parent = target.parentElement;
                            if (parent) {
                              parent.innerHTML = '<div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center"><div class="w-12 h-12 bg-gray-300 rounded"></div></div>';
                            }
                          }}
                        />
                      ) : (
                    ...
                    allImages[modalImageIndex].startsWith('/api/placeholder/') ? (
                      ...
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          const parent = target.parentElement;
                          if (parent) {
                            parent.innerHTML = '<div class="w-full h-full flex items-center justify-center"><div class="text-gray-400 text-center p-8"><div class="w-64 h-64 bg-gray-300 rounded-2xl mx-auto mb-6"></div><p class="text-xl font-medium">Image not available</p><p class="text-sm mt-2 opacity-70">Click outside or press ESC to close</p></div></div>';
                          }
                        }}
                      />
                    ) : (
